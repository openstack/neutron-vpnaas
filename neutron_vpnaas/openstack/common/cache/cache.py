...
#
# Please refer to
# https://etherpad.openstack.org/p/kilo-neutron_vpnaas-library-proposals for
# the discussion leading to this deprecation.
#
# We recommend helping with the new neutron_vpnaas.cache library being created
...
def get_cache(url='memory://'):
    ...
    mgr = driver.DriverManager('neutron_vpnaas.openstack.common.cache.backends', backend,
                               invoke_on_load=True,
                               invoke_args=[parsed],
                               invoke_kwds=kwargs)
    return mgr.driver
